/* =============================================================
   Home Services concierge overlay — same shape as destura-portfolio's
   js/chat.js, adapted for this niche: the CTA on booking intent is a
   "Call Now" tel: link, not a Cal.com popup, since a phone call (not
   a self-serve calendar) is the real conversion action here.
   ============================================================= */
(function () {
  "use strict";
